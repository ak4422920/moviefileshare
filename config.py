...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://akc:akc@cluster0.w6hlw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DB_NAME", "filesharexbot")


CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002302070808"))
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002442422204"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002442422204"))
...
try:
    ADMINS=[6848088376]
    for x in (os.environ.get("ADMINS", "1049173662 7781222730").split()):
        ADMINS.append(int(x))
except ValueError:
